...
Das Script im Ordner /eSM erweitert das bestehende eSM Dashboard um einen Temperaturgraphen zur Darstellung der CPU-Temperatur im zeitlichen Verlauf (60 Minuten).
