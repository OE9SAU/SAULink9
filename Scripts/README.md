...
### v2.1 GPIO12 auch als Trigger bei fehlender Reflektorverbindung für Watchdog-Anwendung hinzugefügt

v2.0 GPIO12 als Trigger für gestoppten SVXLink Dienst für Watchdog-Anwendung hinzugefügt, sowie Service/Reflektor Check nur 1x/Sekunde prüfen
...
| 3 | ✅ Aktiv | ✅ UP | 🔴 Ein | 🔴 Schnell blinkend | Verbindung zum SVXReflector erfolgreich hergestellt. |
| 4 | ✅ Aktiv | ❌ ERROR | 🔴 Ein | 🔴 Dauerlicht | Fehler der Reflektorverbindung (Heartbeat Timeout, Access denied oder Disconnect). |
